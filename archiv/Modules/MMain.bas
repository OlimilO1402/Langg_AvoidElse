...
Private mBarTender As Bartender2
...
Sub Main()
    ...
    Set mBarTender = MNew.Bartender2(MNew.FuncOfString(Console, "ReadLine"), MNew.ActionOfString(Console, "WriteLine"))
...
Try: On Error GoTo Catch
    If IsNumeric(s) Then Lng_out = CLng(s)
    Lng_TryParse = True
    Exit Function
Catch:
End Function
